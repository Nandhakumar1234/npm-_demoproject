		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo Project",
									"targetURL": "#commobodemodemoproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commobodemodemoproject-display": {
								"semanticObject": "commobodemodemoproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mobo.demo.demoproject",
									"url": sap.ui.require.toUrl("com/mobo/demo/demoproject")
								}
							}
						}
					}
